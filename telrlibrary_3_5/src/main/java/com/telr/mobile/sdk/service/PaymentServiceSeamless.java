...
public class PaymentServiceSeamless {

    private static final String TAG ="PaymentService" ;

    public void isValidRequestSeamless(Context context, MobileRequestSeamless mobileRequest, String successActivtyName, String failedActivityName, boolean isSecurityEnabled) throws PaymentException {
    ...
    private boolean validateRequest(MobileRequestSeamless mobileRequest, String successActivtyName, String failedActivityName) {
    ...
    public void updateSDKVersion(MobileRequestSeamless mobileRequest) {
